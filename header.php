...
<head>
  ...
  <meta name="description" content="WordPressをこよなく愛するwebコーダーtsuruのポートフォリオサイトです">
  <meta name="keywords" content="ブログ,blog,コーディング,WordPress,ポートフォリオ">
  <?php wp_head(); ?>
</head>
          ...
          <section class="l-header__inner">
            <h1 class="c-margin-center p-header__logo">
              <a href="<?php echo esc_url(home_url('/')); ?>">
                <img src="<?php echo esc_url(get_template_directory_uri()); ?>/dist/assets/images/logojinuki.png" alt="WebエンジニアTsuruのポートフォリオサイトです。">
              </a>
            </h1>
